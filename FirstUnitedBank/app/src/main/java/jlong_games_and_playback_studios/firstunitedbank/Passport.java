...
/**
 * Write a description of class Passport here.
 *
 * @author (your name)
...
public class Passport
{
   ...
   public Passport(String f, String l, int bM, int bD, int bY, String add, int eM, int eY, boolean male, Resources res){
       firstName = f;
       lastName = l;
       bMonth = bM;
       bDay = bD;
    ...
    public void errorPassport() {
        int error = (int) (Math.random() * 3);
        if (error == 0) {
            int errorPass = (int) (Math.random() * 2);
            if (errorPass == 0) {
